...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.number_line_edit, 7, 1, 1, 2)
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 2, 0, 1, 1)
        self.save_btn = QtWidgets.QPushButton(self.centralwidget)
        self.save_btn.setObjectName("save_btn")
        self.gridLayout.addWidget(self.save_btn, 8, 3, 1, 1)
        self.save_n_exit_btn = QtWidgets.QPushButton(self.centralwidget)
        self.save_n_exit_btn.setObjectName("save_n_exit_btn")
        self.gridLayout.addWidget(self.save_n_exit_btn, 8, 1, 1, 1)
        ...
        self.supplier_id_line_edit = QtWidgets.QLineEdit(self.centralwidget)
        self.supplier_id_line_edit.setObjectName("supplier_id_line_edit")
        self.gridLayout.addWidget(self.supplier_id_line_edit, 1, 1, 1, 3)
        self.email_line_edit = QtWidgets.QLineEdit(self.centralwidget)
        self.email_line_edit.setObjectName("email_line_edit")
        self.gridLayout.addWidget(self.email_line_edit, 6, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.supplier_name_line_edit, 2, 1, 1, 3)
        self.save_n_new_btn = QtWidgets.QPushButton(self.centralwidget)
        self.save_n_new_btn.setObjectName("save_n_new_btn")
        self.gridLayout.addWidget(self.save_n_new_btn, 8, 2, 1, 1)
